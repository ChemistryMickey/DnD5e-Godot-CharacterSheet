...
func update_spell_attributes():
	$SpellSaveDC/LineEdit.text = str(8 + ability_bonus + proficiency_bonus)
	$SpellAttackBonus/LineEdit.text = str(ability_bonus + proficiency_bonus)
